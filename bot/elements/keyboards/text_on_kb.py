...
back_to_global_answers = "Вeрнуться назад ↩"  # Буква "e" английская
back_to_my_answers = "Вepнуться нaзaд ↩"  # Все бувы  "a" английские, буква "p" аннглийская
...
vote_answer = "Проголосовать за ответ" # Полностью русские символы

next_question = "Следующий вопрос"  # Полностью русские символы
vote_question = "Проголосовать за вопрос" # Полностью русские символы
